...
const questions = [
    ...
    },
    {
        ...
        image: "StationsOfTheCross_04_Main-640w.jpg",
        options: ["4", "1", "3", "6"],
        answer: "3"
    }
];
...
/*sounds Effect*/
const correctSound = new Audio("freesound_community-correct-choice-43861.mp3");
const wrongSound = new Audio("gta-ctw-wrong-buzzer-sound.mp3");
const congrats = new Audio("correcto_Xgyp04B.mp3");
const backgroundMusic = new Audio("hauntsync-habemus-papam-catholic-pipe-organ-tribute-339173.mp3");
backgroundMusic.volume = 0.2; // 20% volume
const startGame = new Audio("Video Project.mp3");
